...
ckpt_path = './tl_checkpoints/tl_species_epoch=399-step=5600.ckpt' 
...
if __name__ == "__main__":
    #Stemroot
    stem_logger = TensorBoardLogger(parent_dir, name="tl_species_for_stem_root")
    ...
    #dmcot
    dmcot_logger = TensorBoardLogger(parent_dir, name="tl_species_for_dmcot")
